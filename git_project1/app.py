...
def init_db():
  ...
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="20" fill="#000">{name}</text>
    ...
    products = [
        ('dress', 'dresses', 410.00, 'a silk dress with lace frills', svg_data('dress','ffd1dc')),
        ('top and skirt suit', 'sets', 310.00, 'corset top and pleated skirt', svg_data('set','cfe8ff')),
        ('skirt', 'skirts', 210.00, 'skirt with sewn flowers', svg_data('skirt','d6f5d6')),
